    ...
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProjectAdmins", x => new { x.AdminsId, x.ProjectsId });
                    table.ForeignKey(
                        name: "FK_ProjectAdmins_AspNetUsers_AdminsId",
                        column: x => x.AdminsId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ProjectAdmins_Projects_ProjectsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectAdmins_ProjectsId",
                table: "ProjectAdmins",
                column: "ProjectsId");
